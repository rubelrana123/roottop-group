    ...
    <section className="bg-[#f7f7f7] py-24">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <span className="text-green-700 text-base font-bold uppercase tracking-[3px]">
            Our Ecosystem
          </span>
                    ...
                    <div className="relative p-6">
                      ...
                      <div className="mt-6">
                        <Link
                          ...
                          className="block rounded-lg bg-primary px-5 py-3 text-center text-sm font-semibold text-white transition hover:brightness-95"
                        >
                          Visit Website
                        </Link>
                      </div>
